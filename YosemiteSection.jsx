...
//       .then((res) => res.json())
//       .then((data) => {
//         const yosemiteCategory = data?.top_navigation?.find(
//           (cat) =>
//             cat.cat_name?.toLowerCase().includes("yosemite")
//         );

//         if (yosemiteCategory) {
//           setTours(yosemiteCategory.tours || []);
//         }
//       })
//       .catch((err) => console.log("Error fetching Yosemite:", err));
//   }, []);
  ...
  return (
    <section className="py-20 bg-white overflow-hidden">
      ...
      <SectionHeading>
        Yosemite Adventures & Travel Packages
      </SectionHeading>
