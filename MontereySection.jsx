...
export default function MontereySection({ tours = [] }) {
...
//       .then((res) => res.json())
//       .then((data) => {
//         const montereyCategory = data?.top_navigation?.find(
//           (cat) =>
//             cat.cat_name?.toLowerCase().includes("monterey")
//         );

//         if (montereyCategory) {
//           setTours(montereyCategory.tours || []);
//         }
//       })
//       .catch((err) => console.log("Error fetching Monterey:", err));
//   }, []);
  ...
  return (
    <section className="py-20 bg-gray-50 overflow-hidden">
      ...
      {/* Section Heading */}
      <SectionHeading>
        Discover Monterey, Big Sur & Hearst Castle
      </SectionHeading>
